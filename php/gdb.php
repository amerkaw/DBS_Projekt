...
<body>
    ...
    <div id="header">
		<h2> Gross Domestic Product per dollar</h2>
	</div>
    ...
    ajax1.onreadystatechange=function(){
        ...
        if(this.readyState=4 && this.status == 200){
            ...
            for(var i= 0; i< data1.length; i++){
                ...
                Count1.push ([parseInt(data1[i].Year),parseInt(data1[i].Amount_in_dollar)]);       
            }

            var ajax2= new XMLHttpRequest();
            var method ="GET";
            var url = "gdb_data2.php";
            var asynchronous =true;
            ...
            ajax2.onreadystatechange=function(){
                ...
                if(this.readyState=4 && this.status == 200){
                    ...
                    for(var i= 0; i< data2.length; i++){
                        ...
                        Count2.push ([parseInt(data2[i].Year),parseInt(data2[i].Amount_in_dollar)]);       
                     }   
                    console.log(Count2);
                     
                    var ajax3= new XMLHttpRequest();
                    var method ="GET";
                    var url = "gdb_data3.php";
                    var asynchronous =true;
                        ...
                        if(this.readyState=4 && this.status == 200){
                            ...
                            var Count3=[];
                             ...
                             for(var i= 0; i< data3.length; i++){
                                ...
                                Count3.push ([parseInt(data3[i].Year),parseInt(data3[i].Amount_in_dollar)]);       
                             }
