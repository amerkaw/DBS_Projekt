...
<body>
    ...
    <div id="header">
		<h2> Co2 Emission in ton</h2>
	</div>
 
    <div class="card">
		<div class="card-header">In China, India and United States</div>
	</div>
...
<script >
    ...
    var method ="GET";
    var url = "co2_emission_data1.php";
    ...
    ajax1.onreadystatechange=function(){
        ...
        if(this.readyState=4 && this.status == 200){
            ...
            for(var i= 0; i< data1.length; i++){
                ...
                Count1.push ([parseFloat(data1[i].Year),parseFloat(data1[i].Amount_in_ton)]);       
            }
            console.log(Count1);

            var ajax2= new XMLHttpRequest();
            var method ="GET";
            var url = "co2_emission_data2.php";
            var asynchronous =true;
            ...
            ajax2.onreadystatechange=function(){
                ...
                if(this.readyState=4 && this.status == 200){
                    ...
                    for(var i= 0; i< data2.length; i++){
                        ...
                        Count2.push ([parseFloat(data2[i].Year),parseFloat(data2[i].Amount_in_ton)]);       
                     }   
                    console.log(Count2);
                     
                    var ajax3= new XMLHttpRequest();
                    var method ="GET";
                    var url = "co2_emission_data3.php";
                    var asynchronous =true;
                        ...
                        if(this.readyState=4 && this.status == 200){
                            ...
                            var Count3=[];
                             ...
                             for(var i= 0; i< data3.length; i++){
                                ...
                                Count3.push ([parseFloat(data3[i].Year),parseFloat(data3[i].Amount_in_ton)]);       
                             }
                            console.log(Count3);
